...
public record PaperMetadataDto(
                ...
                @JsonProperty("abstract") @Schema(name = "abstract", description = "Paper abstract. Ensured by MetadataEnrichmentService") String abstractText,
                @Schema(description = "List of authors. Ensured by MetadataEnrichmentService") List<AuthorDto> authors,
                @Schema(description = "Publication date (YYYY-MM-DD format). Ensured by MetadataEnrichmentService") LocalDate publicationDate,
                ...
                @Schema(description = "The primary academic API source (e.g., 'Semantic Scholar', 'arXiv'). Added by SearchOrchestrator") String source,

                // PDF and Access Information
                @Schema(description = "The permanent URL to the PDF stored in B2 storage. Added by PDFProcessorService") String pdfContentUrl,
                ...
                @Schema(description = "Type of publication (e.g., 'JournalArticle', 'Conference')") List<String> publicationTypes,
