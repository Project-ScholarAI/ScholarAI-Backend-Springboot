...
public record AuthorDetailsDto(
        @Schema(description = "Author's full name", example = "Dr. Jane Smith") String name,
        @Schema(description = "Author's affiliation/institution", example = "MIT Computer Science Department")
                String affiliation,
        @Schema(description = "Author's email address", example = "jane.smith@mit.edu") String email) {}
