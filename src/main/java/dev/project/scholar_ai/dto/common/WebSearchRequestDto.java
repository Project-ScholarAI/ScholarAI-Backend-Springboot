...
public record WebSearchRequestDto(
    ...
    @Schema(description = "Search terms/keywords for finding papers", 
            example = "[\"machine learning\", \"neural networks\", \"optimization\"]")
    @NotEmpty(message = "Query terms cannot be empty")
    List<String> queryTerms,
    
    @Schema(description = "Academic domain/field of study", 
            example = "Computer Science",
            allowableValues = {"Computer Science", "Mathematics", "Physics", "Biology", "Chemistry", "Medicine", "Engineering", "Psychology", "Economics"})
    @NotBlank(message = "Domain cannot be blank")
    String domain,
    
    @Schema(description = "Number of papers to fetch (1-50)", 
            example = "10", 
            minimum = "1", 
            maximum = "50")
