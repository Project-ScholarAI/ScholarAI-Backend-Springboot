...
public class UserAccountService {
    ...
    public UserAccount updateAccount(UUID userId, UserAccountDTO userAccountDTO){
        ...
        if (userAccountDTO.getGoogleScholarUrl() != null) userAccount.setGoogleScholarUrl(userAccountDTO.getGoogleScholarUrl());
        ...
        if (userAccountDTO.getStateProvinceRegion() != null) userAccount.setStateProvinceRegion(userAccountDTO.getStateProvinceRegion());
        ...
        if (userAccountDTO.getLanguagePreference() != null) userAccount.setLanguagePreference(userAccountDTO.getLanguagePreference());
