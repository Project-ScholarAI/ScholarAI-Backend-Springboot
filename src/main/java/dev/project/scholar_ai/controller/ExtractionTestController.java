...
public class ExtractionTestController {
    ...
    public ResponseEntity<Map<String, Object>> getPapersReadyForExtraction(
        ...
        try {
            ...
            var papers = paperRepository.findByPdfUrlIsNotNullAndExtractedTextIsNull().stream()
                    .limit(limit)
                    .map(paper -> {
    ...
    public ResponseEntity<Map<String, Object>> simulateExtractionResult(
            @PathVariable UUID paperId, @RequestBody(required = false) Map<String, String> requestBody) {
        ...
        try {
            ...
            ExtractionResult fakeResult = ExtractionResult.builder()
                    ...
                    .paperId(paperId)
                    .extractedText(
                            "This is fake extracted text for testing purposes. The quick brown fox jumps over the lazy dog.")
                    .status("COMPLETED")
                    .errorMessage(null)
    ...
    public ResponseEntity<Map<String, Object>> testRabbitMQDirect(@PathVariable UUID paperId) {
        ...
        try {
            ...
            ExtractionResult testResult = ExtractionResult.builder()
                    ...
                    .paperId(paperId)
                    .extractedText(
                            "TEST MESSAGE: This is a direct RabbitMQ test message with real extracted text from FastAPI.")
                    .status("COMPLETED")
                    .errorMessage(null)
            ...
            rabbitTemplate.convertAndSend(
                    rabbitMQConfig.getExchangeName(), rabbitMQConfig.getExtractionCompletedRoutingKey(), testResult);
